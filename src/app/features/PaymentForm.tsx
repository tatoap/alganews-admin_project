...
import { BusinessError } from 'tato_ap-sdk/dist/errors';
...
import AskForPaymentPreview from '../components/AskForPaymentPreview';
          ...
          {fetchingPaymentPreview ? (
            ...
            <Tabs defaultActiveKey={'payment'}>
                      ...
                      label={
                        <Space>
                          ...
                          <Tooltip title={bonus.title}>
                            <InfoCircleFilled style={{ color: '#09f', fontSize: 18 }} />
                          </Tooltip>
                        </Space>
                      }
                    >
              ...
              <Tabs.TabPane tab={'Dados bancários'} key={'bankAccount'}>
                <Descriptions bordered labelStyle={{ width: 160 }} size={'small'} column={1}>
